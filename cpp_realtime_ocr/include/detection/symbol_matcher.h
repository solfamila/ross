...
public:
    ...
    // Returns best NCC score and location in ROI across loaded templates.
    SymbolMatch matchInGrayROIWithLoc(const std::vector<uint8_t>& frameGray, int frameW, int frameH,
                                      const ROI& roi) const;
